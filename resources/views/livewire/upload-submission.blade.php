<div x-data="state()">
    <div x-show="!file" class="flex items-center justify-center w-full">
        <label for="dropzone-file"
            ...
            <input wire:model="file" wire:loading.attr="disabled" x-on:change="getFileInfo" id="dropzone-file"
    ...
    <div x-show="file"
        ...
        <form action="" wire:submit.prevent="uploadSubmission">
            <div class="mt-6">
        ...
        dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        <span wire:loading wire:target="uploadSubmission">Process...</span>
                        <span wire:loading.class="hidden" wire:target="uploadSubmission">Submit</span>
                    </button>
                @endif
